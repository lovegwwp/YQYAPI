					...
					if (pLevel == 4) {
						...
						if (list != null && list.size() > 0) {
							...
							List<UserBean> nameById = userMapper
									.getUserNameById(userRecord.getuId());
							...
							if (nameById != null && nameById.size() > 0) {
								...
								if (level1 == 3 || level1 == 4) {
									...
									Criteria criteria1 = example1
											.createCriteria();
									criteria1
											.andUIdEqualTo(userRecord.getrId());
									...
									if (list2 != null && list2.size() > 0) {
										UUserRRecordB userRecord2 = list2
												.get(0);
										List<UserBean> nameById2 = userMapper
												.getUserNameById(userRecord2
														.getuId());
										if (nameById2 != null
												&& nameById2.size() > 0) {
											UserBean userBean2 = nameById2
													.get(0);
											JBonusGlj bonusGlj2 = new JBonusGlj();
											bonusGlj2.setuId(userRecord2
													.getuId());
											bonusGlj2.setuName(userBean2
													.getRealName());
											bonusGlj2.setParentId(userRecord2
													.getrId());
											bonusGlj2.setParentMoney(40.00);
											bonusGlj2.setStatus(1);
											bonusGlj2.setCreated(sdf
													.format(new Date()));
						...
						if (pLevel == 4) {
							...
							if (list1 != null && list1.size() > 0) {
								...
								List<UserBean> nameById1 = userMapper
										.getUserNameById(userRecord1.getuId());
								if (nameById1 != null && nameById1.size() > 0) {
									...
									bonusFdj1
											.setCreated(sdf.format(new Date()));
									bonusFdj1.setuName(userBean2.getRealName());
							...
							if (list1 != null && list1.size() > 0) {
								...
								if (nameById1 != null && nameById1.size() > 0) {
									...
									if (pLevel1 == 3 || pLevel1 == 4) {
										...
										bonusFdj1.setAmount(amount);
										bonusFdj1.setStatus(1);
										bonusFdj1.setCreated(sdf
												.format(new Date()));
										bonusFdj1.setuName(userBean2
												.getRealName());
										...
										if (list2 != null && list2.size() > 0) {
											...
											if (nameById2 != null
													&& nameById2.size() > 0) {
												UserBean userBean3 = nameById2
														.get(0);
												JBonusFdj bonusFdj2 = new JBonusFdj();
												bonusFdj2.setuId(userRecord1
														.getrId());
												bonusFdj2
														.setParentId(userRecord2
																.getrId());
												bonusFdj2.setAmount(amount);
												bonusFdj2.setStatus(1);
												bonusFdj2.setCreated(sdf
														.format(new Date()));
												bonusFdj2.setuName(userBean3
														.getRealName());
												bonusFdj2
														.setParentMoney(amount * 0.02);
												jBonusFdjMapper
														.insert(bonusFdj2);
											}
